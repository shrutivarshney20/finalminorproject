...
app.post('/signup', async (req, res) => {
    ...
    // const { name, password, email, branch, year } = req.body;
...
const { name, password,year,branch,email } = req.body;
...
try {
    ...
    const newUser = new LogInCollection({ name, password, email,year,branch });
    await newUser.save();
